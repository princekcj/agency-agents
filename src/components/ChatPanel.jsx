...
import { X, Send, Settings, Bot, User, Loader, Key, ChevronDown, Trash2 } from 'lucide-react';
...
function buildSystemPrompt(agent) {
  const systemIntro = `You are ${agent.name}, a specialized AI agent in The Agency.
    ...
    <div className="chat-panel">
      ...
      {showSettings && (
        <div className="chat-settings">
          ...
          <div className="chat-settings-row" style={{ marginTop: 10 }}>
            <Bot size={11} />
          ...
          <div className="chat-messages">
            {messages.length === 0 && (
              <div className="chat-empty">
                ...
                <div className="chat-empty-hint">Start a conversation. The agent is ready.</div>
                <div className="chat-empty-model">
                  <Bot size={10} /> {modelLabel}
                </div>
              </div>
            )}
            {messages.map((m, i) => (
