            ...
            <React.Fragment key={`${step.id}-${i}`}>
              <div className="pipeline-stage">
                ...
                <button
                  ...
                  title="Configure step prompt and I/O"
                >
                  <Settings size={10} />
                </button>
                ...
                <div className="pipeline-step-config">
                  <div className="pipeline-step-config-field">
                    ...
                    <textarea
                      ...
                      placeholder="Custom additions to this agent's system prompt for this step. E.g. 'Focus only on sentiment analysis.'"
                  ...
                  <div className="pipeline-step-config-field">
                    ...
                    <textarea
                      ...
                      placeholder={i === 0
                        ...
                        : 'E.g. "The previous agent extracted key entities. Now classify each one by type."'
                      }
                  ...
                  <div className="pipeline-step-config-field">
                    ...
                    <textarea
                      ...
                      placeholder={i === pipeline.length - 1
                        ? 'E.g. "Return JSON with keys: summary, actions, confidence."'
                        : 'E.g. "Produce a numbered list so the next agent can process each item individually."'
                      }
